...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		imprimir();
		imprimir("Cantidad notas : " + an.tamanio());
		imprimir("Nota promedio : " + an.notaPromedio());
		imprimir("Nota mayor : " + an.notaMayor());
		imprimir("Nota menor : " + an.notaMenor());
		imprimir("Cantidad aprobados : " + an.cantNotasAprobatorias());
		imprimir("Cantidad desaprobados : " + an.cantNotasDesaprobatorias());
		imprimir("Cantidad notas mayores a 15 : " + an.cantNotasMayoresA15());
		imprimir("Posición primer aprobado : " + an.posPrimeraNotaAprobatoria());
		imprimir("Posición penúltimo desaprobado : " + an.posPenultimaNotaDesaprobatoria());
	}
