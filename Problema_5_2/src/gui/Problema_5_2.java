...
public class Problema_5_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Posición del segundo sueldo mayor al mínimo : " + as.posSegundoSueldoMayorAlMinimo());
		imprimir("Posición último sueldo menor al mínimo : " + as.posUltimoSueldoMenorAlMinimo());
